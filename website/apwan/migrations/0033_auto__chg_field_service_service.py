...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.service'
        db.alter_column('apwan_service', 'service', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Service.service'
        db.alter_column('apwan_service', 'service', self.gf('django.db.models.fields.IntegerField')())
