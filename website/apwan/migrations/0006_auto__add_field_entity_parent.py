...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.parent'
        db.add_column('apwan_entity', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apwan.Entity'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.parent'
        db.delete_column('apwan_entity', 'parent_id')
