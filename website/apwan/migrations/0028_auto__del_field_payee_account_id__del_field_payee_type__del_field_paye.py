...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Payee.type'
        db.delete_column('apwan_payee', 'type')

        # Deleting field 'Payee.token'
        db.delete_column('apwan_payee', 'token')

        # Adding field 'Payee.account'
        db.add_column('apwan_payee', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apwan.Service'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Payee.account_id'
        db.add_column('apwan_payee', 'account_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Payee.type'
        raise RuntimeError("Cannot reverse this migration. 'Payee.type' and its values cannot be restored.")
        # Adding field 'Payee.token'
        db.add_column('apwan_payee', 'token',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True),
                      keep_default=False)

        # Deleting field 'Payee.account'
        db.delete_column('apwan_payee', 'account_id')
    ...
    models = {
        ...
        'apwan.payee': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['apwan.Service']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
