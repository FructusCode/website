...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.deployauth_token'
        db.add_column('apwan_userprofile', 'deployauth_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.deployauth_token'
        db.delete_column('apwan_userprofile', 'deployauth_token')
    ...
    models = {
        ...
        'apwan.userprofile': {
            ...
            'deployauth_token': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
