...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.s_title'
        db.add_column('apwan_entity', 's_title',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Entity.s_artist'
        db.add_column('apwan_entity', 's_artist',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Entity.s_album'
        db.add_column('apwan_entity', 's_album',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Entity.s_track'
        db.add_column('apwan_entity', 's_track',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.s_title'
        db.delete_column('apwan_entity', 's_title')

        # Deleting field 'Entity.s_artist'
        db.delete_column('apwan_entity', 's_artist')

        # Deleting field 'Entity.s_album'
        db.delete_column('apwan_entity', 's_album')

        # Deleting field 'Entity.s_track'
        db.delete_column('apwan_entity', 's_track')
