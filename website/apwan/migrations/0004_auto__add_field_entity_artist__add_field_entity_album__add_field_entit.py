...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.artist'
        db.add_column('apwan_entity', 'artist',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Entity.album'
        db.add_column('apwan_entity', 'album',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Entity.track'
        db.add_column('apwan_entity', 'track',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


        # Changing field 'Entity.title'
        db.alter_column('apwan_entity', 'title', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):
        # Deleting field 'Entity.artist'
        db.delete_column('apwan_entity', 'artist')

        # Deleting field 'Entity.album'
        db.delete_column('apwan_entity', 'album')

        # Deleting field 'Entity.track'
        db.delete_column('apwan_entity', 'track')


        # User chose to not deal with backwards NULL issues for 'Entity.title'
        raise RuntimeError("Cannot reverse this migration. 'Entity.title' and its values cannot be restored.")
