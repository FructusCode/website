...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipient.owner'
        db.alter_column('apwan_recipient', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Recipient.payee'
        db.alter_column('apwan_recipient', 'payee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apwan.Payee'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Recipient.owner'
        raise RuntimeError("Cannot reverse this migration. 'Recipient.owner' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Recipient.payee'
        raise RuntimeError("Cannot reverse this migration. 'Recipient.payee' and its values cannot be restored.")
