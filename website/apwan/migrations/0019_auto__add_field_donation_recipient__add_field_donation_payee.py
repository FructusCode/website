...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.recipient'
        db.add_column('apwan_donation', 'recipient',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apwan.Recipient'], null=True),
                      keep_default=False)

        # Adding field 'Donation.payee'
        db.add_column('apwan_donation', 'payee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apwan.Payee'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.recipient'
        db.delete_column('apwan_donation', 'recipient_id')

        # Deleting field 'Donation.payee'
        db.delete_column('apwan_donation', 'payee_id')
