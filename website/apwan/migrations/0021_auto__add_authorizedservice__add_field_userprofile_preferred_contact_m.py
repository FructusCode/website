...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AuthorizedService'
        db.create_table('apwan_authorizedservice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('apwan', ['AuthorizedService'])

        # Adding field 'UserProfile.preferred_contact_method'
        db.add_column('apwan_userprofile', 'preferred_contact_method',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AuthorizedService'
        db.delete_table('apwan_authorizedservice')

        # Deleting field 'UserProfile.preferred_contact_method'
        db.delete_column('apwan_userprofile', 'preferred_contact_method')
