...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthorizedService.owner'
        db.add_column('apwan_authorizedservice', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'AuthorizedService.service'
        db.add_column('apwan_authorizedservice', 'service',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AuthorizedService.type'
        db.add_column('apwan_authorizedservice', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AuthorizedService.data'
        db.add_column('apwan_authorizedservice', 'data',
                      self.gf('json_field.fields.JSONField')(default='null'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthorizedService.owner'
        db.delete_column('apwan_authorizedservice', 'owner_id')

        # Deleting field 'AuthorizedService.service'
        db.delete_column('apwan_authorizedservice', 'service')

        # Deleting field 'AuthorizedService.type'
        db.delete_column('apwan_authorizedservice', 'type')

        # Deleting field 'AuthorizedService.data'
        db.delete_column('apwan_authorizedservice', 'data')


    models = {
        'apwan.authorizedservice': {
            'Meta': {'object_name': 'AuthorizedService'},
