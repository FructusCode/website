...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthorizedService.account_id'
        db.add_column('apwan_authorizedservice', 'account_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthorizedService.account_id'
        db.delete_column('apwan_authorizedservice', 'account_id')
