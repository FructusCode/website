...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payee.user'
        db.add_column('apwan_payee', 'user',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Payee.user'
        db.delete_column('apwan_payee', 'user_id')
    ...
    models = {
        ...
        'apwan.payee': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['apwan.Service']", 'null': 'True'})
        },
        'apwan.recipient': {
