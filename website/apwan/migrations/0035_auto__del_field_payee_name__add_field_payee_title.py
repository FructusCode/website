...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payee.title'
        db.add_column('apwan_payee', 'title',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Payee.name'
        raise RuntimeError("Cannot reverse this migration. 'Payee.name' and its values cannot be restored.")
        # Deleting field 'Payee.title'
        db.delete_column('apwan_payee', 'title')
