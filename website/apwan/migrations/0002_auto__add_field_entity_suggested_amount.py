...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.suggested_amount'
        db.add_column('apwan_entity', 'suggested_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.suggested_amount'
        db.delete_column('apwan_entity', 'suggested_amount')
