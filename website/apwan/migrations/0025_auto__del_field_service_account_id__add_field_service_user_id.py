...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Service.account_id'
        db.delete_column('apwan_service', 'account_id')

        # Adding field 'Service.user_id'
        db.add_column('apwan_service', 'user_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Service.account_id'
        db.add_column('apwan_service', 'account_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Deleting field 'Service.user_id'
        db.delete_column('apwan_service', 'user_id')
    ...
    models = {
        ...
        'apwan.service': {
            ...
            'user_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64'})
        },
        'apwan.userprofile': {
