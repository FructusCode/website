...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apwan_entity', 'image', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Entity.suggested_amount'
        db.alter_column('apwan_entity', 'suggested_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Entity.image'
        raise RuntimeError("Cannot reverse this migration. 'Entity.image' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Entity.suggested_amount'
        raise RuntimeError("Cannot reverse this migration. 'Entity.suggested_amount' and its values cannot be restored.")
