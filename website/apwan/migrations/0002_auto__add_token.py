...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Token'
        db.create_table('apwan_token', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('token_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('data', self.gf('json_field.fields.JSONField')(default='null', null=True, blank=True)),
            ('expire', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('apwan', ['Token'])


    def backwards(self, orm):
        # Deleting model 'Token'
        db.delete_table('apwan_token')
