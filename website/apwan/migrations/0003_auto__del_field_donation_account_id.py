...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Donation.account_id'
        db.delete_column('apwan_donation', 'account_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Donation.account_id'
        raise RuntimeError("Cannot reverse this migration. 'Donation.account_id' and its values cannot be restored.")
