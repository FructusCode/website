...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('apwan_service', 'type')

        # Adding field 'Service.service_type'
        db.add_column('apwan_service', 'service_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Service.link_type'
        db.add_column('apwan_service', 'link_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'Service', fields ['service_id', 'service']
        db.create_unique('apwan_service', ['service_id', 'service'])


    def backwards(self, orm):
        # Removing unique constraint on 'Service', fields ['service_id', 'service']
        db.delete_unique('apwan_service', ['service_id', 'service'])

        # Adding field 'Service.type'
        db.add_column('apwan_service', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Service.service_type'
        db.delete_column('apwan_service', 'service_type')

        # Deleting field 'Service.link_type'
        db.delete_column('apwan_service', 'link_type')
