...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payee.slug'
        db.alter_column('apwan_payee', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=32))


    def backwards(self, orm):
        # Removing index on 'Payee', fields ['slug']
        db.delete_index('apwan_payee', ['slug'])


        # Changing field 'Payee.slug'
        db.alter_column('apwan_payee', 'slug', self.gf('django.db.models.fields.CharField')(max_length=32))
