...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Donation.currency'
        db.alter_column('apwan_donation', 'currency', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Donation.currency'
        db.alter_column('apwan_donation', 'currency', self.gf('django.db.models.fields.CharField')(max_length=3))
