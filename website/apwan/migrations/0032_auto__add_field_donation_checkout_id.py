...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.checkout_id'
        db.add_column('apwan_donation', 'checkout_id',
                      self.gf('django.db.models.fields.CharField')(max_length=18, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.checkout_id'
        db.delete_column('apwan_donation', 'checkout_id')
